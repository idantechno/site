...
const packages: Package[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "אנחנו לוקחים את הזהות והאסתטיקה של העסק שלך — ומתרגמים אותן לחוויה דיגיטלית מקצועית שעדיין מרגישה כמוך.",
    ],
    fitForLabel: "מה אתה מקבל בחבילה:",
    fitFor: [
  ...
  },
  {
    ...
    description: [
      ...
      "אנחנו לא משחילים אותך לתבנית. אנחנו לומדים את העסק שלך לעומק לפני שורת קוד אחת — כדי שמה שיוצא לקוחות שלך ירגיש בדיוק כמו ממך, לא ממכונה.",
    ],
    fitForLabel: "מה אתה מקבל בחבילה:",
    fitFor: [
      ...
      "ערובה לאנושיות: כל מילה שהמערכת אומרת עברה אישור שלך, ואין דבר שיוצא ללקוח שלא נשמע כמוך",
    ],
    group: "business",
  },
];
