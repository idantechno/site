...
import { launchPricingNote } from "@/lib/constants";
...
const FAQS = [
  {
    q: "כמה זה עולה?",
    a: `המחיר נקבע לפי מה שהעסק שלך באמת צריך, ומוצג במלואו לפני התשלום. בשיחת האבחון כבר יהיה לך מספר מדויק, בלי הפתעות ובלי אותיות קטנות. חשוב לדעת: אלה מחירי השקה — ${launchPricingNote()}`,
  },
  {
  ...
  },
  {
    ...
    a: "מתחילים מדבר אחד — ולכן זה מהיר. אצל רוב העסקים המערכת באוויר תוך כשבועיים, ולוח זמנים מדויק סוגרים כבר בשיחת האבחון. פתרון עם חיבורים מורכבים לוקח קצת יותר.",
  },
  {
