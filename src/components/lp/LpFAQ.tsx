...
const FAQS = [
  ...
  },
  {
    ...
    a: "לא. המערכת עונה על מה שחוזר על עצמו, כמו תיאומים ושאלות שחוזרות כל יום. כל מה שדורש שיקול דעת או מגע אישי עובר אליך, מסודר ומרוכז.",
  },
  {
    q: "צריך להבין בטכנולוגיה בשביל זה?",
    a: "ממש לא. את כל הצד הטכני אנחנו עושים, מההקמה ועד החיבור ליומן. מבחינתך זה וואטסאפ שפשוט עונה כמו שצריך.",
  },
  {
    q: "כמה זמן לוקח עד שזה עובד?",
    a: "14 יום מהשיחה הראשונה, ברוב העסקים. פתרון עם אינטגרציות מורכבות לוקח קצת יותר, ולוח זמנים מדויק סוגרים כבר בשיחת האבחון.",
  },
  {
    q: "מה קורה כשהמערכת לא יודעת לענות?",
    a: "היא לא ממציאה. שאלה שמחוץ לתחום עוברת אליך בצורה חלקה, והלקוח מקבל הודעה שחוזרים אליו. עדיף שאלה שממתינה מתשובה שגויה.",
  },
  {
    q: "זה יישמע כמו בוט?",
