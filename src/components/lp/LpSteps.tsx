...
// LpSteps — ארבעה שלבים על קו שנמשך בגלילה.
// מטרה: להקטין מאמץ נתפס. מהשיחה הראשונה ועד שזה עובד — בלי שום דבר טכני עליך.
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          >
            ...
            <span style={{ color: "#DC5D46" }}> בלי שום דבר טכני עליך.</span>
          </h2>
        </motion.div>
