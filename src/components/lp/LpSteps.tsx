...
const STEPS = [
  {
    day: "יום 1",
    title: "שיחת היכרות",
    text: "20 דקות בטלפון או בזום. מספרים לנו איך העסק עובד ומה שורף לך זמן.",
  },
  {
    day: "ימים 2–4",
    title: "שאלון עומק",
    text: "איך העסק שלך מדבר? באילו מילים? אוספים את הטון והשפה כדי שהמערכת תישמע כמוך.",
  },
  {
    day: "ימים 5–12",
    title: "הקמה וחיבור",
    text: "אנחנו בונים, מחברים ליומן ולוואטסאפ, ובודקים. אין לך שום דבר טכני לעשות.",
  },
  {
    day: "יום 14",
    title: "באוויר",
    text: "המערכת עונה, ואנחנו נשארים זמינים. כל תשובה אפשר לכוונן גם אחרי ההשקה.",
  },
];
