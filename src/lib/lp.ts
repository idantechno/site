...
export const QUIZ_RESULTS: Record<PlanId, QuizResultCopy> = {
  ...
  design: {
    planId: "design",
    title: "PORTAL DESIGN",
    why: "עסק ויזואלי צריך במה ויזואלית. אתר מעוצב, גלריה ומערכת תיאומים, עם סוכן שעונה לפניות — באתר ובוואטסאפ — בזמן שהעדשה אצלך ביד.",
  },
  comfort: {
    planId: "comfort",
    title: "PORTAL COMFORT",
    why: "סוכן שעונה לפניות — באתר ובוואטסאפ — ועוקב אחרי הלידים. שום דבר לא נופל בין הכיסאות, ורק מה שדורש אותך מגיע אליך.",
  },
};
