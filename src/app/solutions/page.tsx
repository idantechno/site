...
const CAPABILITIES = [
  {
    Icon: ChatCircleDots,
    title: "מענה ותקשורת",
    body: "צוות סוכנים שעונה לפניות ולשאלות חוזרות בשפה ובטון של העסק שלך — מהר, מדויק, ובלי שאף לקוח ייפול בין הכיסאות.",
  },
  {
    Icon: Faders,
    title: "אוטומציה וסדר",
      ...
      <main id="main" className="pt-28 pb-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <header className="max-w-3xl mb-14">
            ...
            >
              מערכת אחת חכמה — שמנהלת איתך את העסק.
            </h1>
            <p className="mt-5 text-lg font-body leading-relaxed" style={{ color: "#374151" }}>
              Portal Studio היא מערכת מבוססת בינה מלאכותית שלוקחת על עצמה את העבודה
              החוזרת בעסק — מענה, סדר, מעקב ואוטומציה — ומחזירה לך זמן ושליטה. כל
